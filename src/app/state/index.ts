...
import {extractParameterGroups, loadCollectionParameters} from './parameters/effects/parameter.effects';
...
export const effects: (Type<unknown> | Record<string, FunctionalEffect>)[] = [{loadCollectionParameters, extractParameterGroups}];
